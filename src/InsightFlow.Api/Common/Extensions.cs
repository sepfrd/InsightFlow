...
namespace InsightFlow.Api.Common;
...
public static class Extensions
{
    extension(IServiceCollection services)
    {
        public IServiceCollection AddDependencies(IConfiguration configuration, IHostEnvironment environment)
        {
            ...
            services
                ...
                .AddCqrs(typeof(IUnitOfWork).Assembly)
                .AddAuth(appOptions)
        ...
        public IServiceCollection AddAuth(AppOptions appOptions) =>
        ...
        public IServiceCollection AddRateLimiters(AppOptions appOptions) =>
            services
        ...
        public IServiceCollection AddCors(AppOptions appOptions) =>
    ...
    {
        public async Task<bool> InitializeRoleServiceAsync(int numberOfRetries)
        {
